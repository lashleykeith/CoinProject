...
const Wishlist = ({
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Fine Bullions | Wishlist</title>
        <meta
          name="description"
                            ...
                            return (
                              <tr key={key}>
                                <td className="product-thumbnail">
                                  ...
                                  >
                                    {wishlistItem.faceImage.includes("http") || wishlistItem.faceImage.includes("data:") ? (
                                      <img src={cartItem.faceImage} className='w-50 h-50' alt='' width="5px" />
                                    ) : (
                                      <img
                                        className='w-50 h-50'

                                        src={`http://localhost:8000/api/ambassador/image/${wishlistItem.id}`}
