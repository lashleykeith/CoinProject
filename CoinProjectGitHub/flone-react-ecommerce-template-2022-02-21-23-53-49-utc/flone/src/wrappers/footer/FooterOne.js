        ...
        <div className="row">
          ...
          <div className="footerImages">
            <a href="https://www.bbb.org/">
              <img src={process.env.PUBLIC_URL + "assets/img/footer/shopper-approved.jpeg"} className="shopappSign" />
            </a>
            <a href="https://www.shopperapproved.com/">
              <img src={process.env.PUBLIC_URL + "assets/img/footer/ab-seal-horizontal.svg"} className="shopappSign" />
            </a>
          </div>
          <div
