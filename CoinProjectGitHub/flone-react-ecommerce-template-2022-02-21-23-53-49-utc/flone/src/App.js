...
import EditProductsTags from "./pages/admin/products/tags/editProductsTags";
import ProductsTags from "./pages/admin/products/tags/productsTags";
import CreateTag from "./pages/admin/products/tags/createTag";
...
const Success = lazy(() => import("./pages/other/checkout/Success"));

const AdminPanel = lazy(() => import("./pages/admin/admin"));
const LoginAdminPanel = lazy(() => import("./pages/admin/login"));
const AdminPanelUsers = lazy(() => import("./pages/admin/users"));
const AdminPanelViewUser = lazy(() => import("./pages/admin/viewUser"));
const AdminViewProducts = lazy(() => import("./pages/admin/products/products"));
...
const ResetPassword = lazy(() => import("./pages/user/ChangePassword"));
          ...
          <ScrollToTop>
            ...
            >
              <Switch>
                ...
                <Route
                  path={process.env.PUBLIC_URL + "/view-user"}
                  component={AdminPanelViewUser}
                />
                ...
                <Route
                  path={process.env.PUBLIC_URL + "/admin-products-edit"}
                ...
                <Route
                  path={process.env.PUBLIC_URL + "/admin-tags-create"}
                  component={CreateTag}
                />

                <Route
                  path={process.env.PUBLIC_URL + "/admin-products-tags"}
                  component={ProductsTags}
                />

                <Route
                  path={process.env.PUBLIC_URL + "/admin-edit-tags"}
                  component={EditProductsTags}
                />
                ...
                <Route
                  path={process.env.PUBLIC_URL + "/reser-password"}
